...
- **Игре нужно минимум 800x600.** У встроенной панели физически только режим 800x480,
  поэтому на время игры лаунчер поднимает масштаб до **0.75** — логически 1066x640, окно
  игры (1063x600) помещается целиком. При выходе масштаб снимается, и система возвращается
  к нормальным 800x480: работать в мелком интерфейсе не нужно. Телевизор решает вопрос прямо.
